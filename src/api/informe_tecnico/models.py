...
class InformeTecnico(db.Model):
  ...
  id_imprevisto = db.Column(db.Integer, db.ForeignKey('imprevisto.id_imprevisto'), nullable=True)
  
  def __init__ (self, fecha_inicio_reparacion, fecha_fin_reparacion, detalle_reparacion, observaciones, saldo_final, id_ost, id_imprevisto = None):
