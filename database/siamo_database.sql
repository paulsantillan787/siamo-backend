...
(
  id_informe_tecnico      int          NOT NULL GENERATED ALWAYS AS IDENTITY,
  id_ost                  int          NOT NULL,
...
COMMENT ON COLUMN Tarea.estado IS '0: no terminada, 1: terminada';
...
CREATE UNIQUE INDEX id_tarea
  ON Tarea (id_tarea ASC);
